...
(a) On average, the fraction of the available observations would be 10%/2*2=10%.

(b) On average,the fraction of the available observations would be 10%*10%=1%

(c) On average, the fraction of the available observations would be 0.1^{100}.
...
(e) Suppose we want to set the length of each side as l, if we want to have l^{p}=0.1 we have to make l=sqrt[p]{0.1}. So:

when p=1, the length is 0.1
when p=2, the length is 0.1^{1/2}=0.316
when p=100, the length is 0.1^{1/100}=0.977
