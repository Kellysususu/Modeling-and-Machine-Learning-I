...
The quadratic model gives more flexibility to our model, which also increases the variance of the model when we change the x to squared terms. The high variance is more likely to result in overfitting of the model. As the variance increases, the bias of the model decreases. Therefore, we need to find a balance between bias and variance to  train our model.
